    ...
    <div className="max-w-7xl mx-auto">
      ...
      <section className=" text-lg my-10">
        ...
        <p className=" ">
          ...
          2005, we've navigated the ever-changing seas of the maritime industry,
          providing a comprehensive suite of services designed to keep your
          vessel operational and thriving. <br />
          At United Marine Engineering & Electrical Works, our guiding principle
          is unwavering commitment to excellence. We've assembled a team of
          highly skilled and experienced professionals, each driven by a shared
          passion: exceeding client expectations and ensuring the safety and
          success of every voyage you undertake. We are relentless innovators,
          constantly expanding our services to meet the evolving needs of the
          maritime landscape. <br />
          We believe in fostering strong, collaborative partnerships with our
          clients. Whether you require reliable ship chandlery, expert repairs,
          efficient supply solutions, or seamless export product services,
          United Marine Engineering & Electrical Works is your one-stop shop,
          dedicated to providing personalized service, transparent
          communication, and cost-effective solutions. <br />
      ...
      <section>
        <p className="text-5xl text-center my-14 font-bold md:w-[70%] leading-tight mx-auto">
          United Marine Engineering & Electrical Works: A Symphony of Expertise
        </p>
