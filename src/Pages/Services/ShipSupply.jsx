...
const services = [
  {
    ...
    subTitle: "Cranes, forklifts, lashing equipment, and other cargo handling solutions tailored to your specific cargo type.",
    icon: shipIcon,
  },

  {
    ...
    subTitle: "We offer a range of equipment to comply with environmental regulations and ensure sustainable maritime operations.",
    icon: shipIcon,
  },
  {
    id: 3,
    title: "Waste Management Equipment",
    subTitle: "We provide solutions for efficient onboard waste management",
    icon: shipIcon,
  },
  {
    id: 4,
    title: "Extensive Inventory & Global Sourcing",
    subTitle: "We maintain a vast inventory and have strong relationships with global suppliers, ensuring you get the right equipment quickly and efficiently.",
    icon: shipIcon,
  },
  {
    id: 5,
    title: "Competitive Prices",
    subTitle: "We leverage our buying power to offer competitive prices on all ship supplies.",
    icon: shipIcon,
  },
  {
    id: 6,
    title: "Expert Advice & Recommendations",
    subTitle: "Our team of experienced professionals can provide expert advice and recommendations to ensure you select the most suitable equipment for your vessel.",
    icon: shipIcon,
  },

  {
    ...
    subTitle: "We understand the importance of timely deliveries. We work closely with logistics partners to ensure your supplies reach you when and where you need them.",
    icon: shipIcon,
  },
];
const ShipSupply = () => {
    ...
    <>
      <section className="max-w-7xl mx-auto md:block flex flex-col-reverse items-center text-lg my-10 p-4">
        ...
        <div>
          <h1 className="text-3xl md:text-5xl font-bold mb-10 leading-snug">
            United Marine Engineering & Electrical Works: Your Complete Ship
            Supply Solution (Electrical, Mechanical & Beyond)
          </h1>
          ...
          <p className=" mb-8">
            ...
            complexities of keeping your vessel operational. That's why we offer
            a comprehensive ship supply solution, encompassing all the essential
            equipment and supplies you need to navigate any voyage with
            confidence.
          </p>
          ...
          <p>
            Our extensive inventory includes a vast array of ship supplies,
            categorized to simplify your procurement process:
          </p>
      ...
      <section className="md:flex max-w-7xl mx-auto gap-24 mb-32 hidden p-4">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="text-lg">
            United Marine Engineering & Electrical Works simplifies ship supply
            by providing a one-stop shop for all your needs. With our extensive
            inventory, expert advice, and efficient logistics network, you can
            rest assured that your vessel is fully equipped for a successful
            voyage.
          </p>
        </div>
      </section>
