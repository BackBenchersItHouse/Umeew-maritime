...
const services = [
  {
    ...
    subTitle: "We leverage our extensive global network to source high-quality products at competitive prices",
    icon: shipIcon,
  },

  {
    ...
    subTitle: "We handle all necessary export documentation and navigate customs clearance procedures efficiently.",
    icon: shipIcon,
  },
  {
    id: 3,
    title: "Packing & Logistics",
    subTitle: "We ensure your products are expertly packaged and shipped to their destination using reliable logistics partners.",
    icon: shipIcon,
  },
  {
    id: 4,
    title: "Export Regulations Expertise: ",
    subTitle: "Our team stays up-to-date on international export regulations, ensuring compliance throughout the process.",
    icon: shipIcon,
  },
  {
    id: 5,
    title: "Seamless Export Process",
    subTitle: "Our team handles all the complexities of international trade, allowing you to focus on your core business.",
    icon: shipIcon,
  },
  {
    id: 6,
    title: "Transparent Communication",
    subTitle: "We keep you informed throughout the export process, from order confirmation to delivery.",
    icon: shipIcon,
  },

  {
    ...
    subTitle: "We leverage our expertise to ensure you receive the best value for your export needs.",
    icon: shipIcon,
  },
];
    ...
    <>
      <section className="max-w-7xl mx-auto md:block flex flex-col-reverse items-center text-lg my-10 p-4">
        ...
        <div>
          <h1 className="text-3xl md:text-5xl font-bold mb-10 leading-snug">
            United Marine Engineering & Electrical Works: Your Trusted Partner
            for Streamlined Ship Parts & Equipment Export
          </h1>
          <h2 className="text-2xl :text-4xl font-semibold mb-4">
            Navigate International Trade with Confidence
          </h2>
          <p className=" mb-8">
            At United Marine Engineering & Electrical Works, we're not just
            experts in keeping your vessel operational – we're also here to
            facilitate your international trade needs. Our export product
            service simplifies the process of acquiring and delivering essential
            ship spare parts, equipment, and machinery globally.
          </p>
          <h3 className="text-xl md:text-3xl font-semibold mb-4">
            Exporting Ship Essentials: Our Expertise
          </h3>
          <p>
            We understand the complexities of international trade. Our export
            services ensure a smooth and efficient process for acquiring and
            delivering the following ship-related products:
          </p>
      ...
      <section className="md:flex max-w-7xl mx-auto gap-24 mb-32 hidden p-4">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="text-lg">
            United Marine Engineering & Electrical Works is your one-stop shop
            for all your ship spare parts, equipment, and machinery export
            needs. With our extensive expertise, global network, and commitment
            to efficient service, we empower you to navigate international trade
            with confidence.
          </p>
        </div>
      </section>
